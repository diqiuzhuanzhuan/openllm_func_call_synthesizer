...
test_data = [{'model': 'claude-sonnet-4', 'function_call': '{}'},
 {'model': 'gemini-2.5',
  'function_call': '{"name": "music_play_control", "arguments": {"play_mode": "normal"}}'},
 {'model': 'gpt-4o',
  'function_call': '{"name": "music_play_control", "arguments": {}}'},
 {'model': 'qwen3-4b-2507',
...
import pandas as pd
df = pd.read_excel('/data0/work/SusieSu/project/openllm_func_call_synthesizer/data/data/function_call_0919/query_and_function_call.xlsx')
...
df_merge = df_merge[['query', 'model_function_calls', 'voted_function_call', 
        'language', 'dimension', 'function_call_model', 'model_function_call']]
df_merge.to_excel('/data0/work/SusieSu/project/openllm_func_call_synthesizer/data/data/function_call_0919/voted_function_call_rs_0919_3models.xlsx')
