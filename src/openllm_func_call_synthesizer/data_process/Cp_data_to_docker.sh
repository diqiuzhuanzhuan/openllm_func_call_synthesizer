...
cp -rf /data0/work/SusieSu/project/openllm_func_call_synthesizer/data/function_call_for_train_1112_v2/mcp_data_1112_for_train  /data0/work/SusieSu/project/workspace/LLaMA-Factory-main/data/mcp_train_data/
cd  /data0/work/SusieSu/project/workspace/LLaMA-Factory-main/data/mcp_train_data/mcp_data_1112_for_train
cp -f mcp_train.json mcp_dev.json ../../